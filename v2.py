...
# ---------------------------------------------------------------------------
CRUISE_SPEED = 0.38            # fast open-road speed (ambulance pace on a clear track)
...
AVOID_FAR_DIST = 2.5           # start ramp-down earlier to absorb extra speed smoothly
...
AVOID_MIN_SPEED = 0.09         # slightly higher creep floor so buggy keeps moving past obstacle
