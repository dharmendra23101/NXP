...
# Lower portions are closer to the buggy, while upper portions see further ahead.
#
# TUNE: increased from 0.225 -> 0.38. The runner's curvature-anticipation
# term needs to see a bend BEFORE the buggy is already in it. A narrow crop
# only shows nearly-straight lines right up until a sharp turn, giving the
# controller no time to react. A wider crop trades a little bit of "false
# curvature noise" on far-away sections for much earlier warning on real
# bends. If steering starts reacting to distant clutter/noise too much,
# lower this back down a bit (e.g. 0.30) rather than all the way to 0.225.
